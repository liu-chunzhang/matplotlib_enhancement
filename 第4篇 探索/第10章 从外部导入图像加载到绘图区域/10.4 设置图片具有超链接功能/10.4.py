...
pc = plt.scatter([351, 823], [343, 163], c='r', edgecolor='r', s=50, alpha=0.8)
...
ax0.annotate("", xy=(351, 343), xytext=(823, 163), xycoords="data", textcoords="data", 
				arrowprops=dict(arrowstyle="fancy, head_length=0.6, head_width=0.6, tail_width=0.5", shrinkA=10, shrinkB=10, 
...
ab_image = AnnotationBbox(imagebox, xy=(351, 343), xybox=(-50, 40), xycoords="data", boxcoords="offset points", pad=0.05, frameon=True, 
...
ab_text = AnnotationBbox(textbox, xy=(823, 163), xybox=(-40, 52), xycoords="data", boxcoords="offset points", pad=0.2, 
							bboxprops=dict(facecolor="gray", alpha=0.5), arrowprops=dict(arrowstyle="-", shrinkA=0, shrinkB=5, 
							relpos=(0.5, 0.0)))
