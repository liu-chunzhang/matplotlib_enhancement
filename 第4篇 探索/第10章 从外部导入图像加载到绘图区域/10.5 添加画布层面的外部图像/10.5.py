...
# figure picture
# use "r" to avoid escape sequence \f 			# 避免加载绝对路径时，发生输入或输出类型的错误
imageData1 = plt.imread("captain-bird.png")
# add an image to the figure
fig.figimage(imageData1, 40, -30, origin="upper", alpha=0.05, resize=True, zorder=1)
...
plt.text(645, 78, "Potential Treasure", family="times new roman cyr", fontsize=20, color='k', weight="bold", rotation=-5)
